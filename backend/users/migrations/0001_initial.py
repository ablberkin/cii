    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_name', models.CharField(max_length=30, null=True, verbose_name='用户名')),
                ...
                ('identity', models.CharField(choices=[('teacher', '教职工'), ('student', '学生'), ('keine ahnung', '游泳')], default='student', max_length=20, verbose_name='身份')),
                ('email', models.EmailField(blank=True, max_length=100, null=True, verbose_name='邮箱')),
                ('collection', models.CharField(blank=True, max_length=11, null=True, verbose_name='收藏')),
