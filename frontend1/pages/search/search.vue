<!-- <template>
	<view>
		<uni-search-bar radius="5" placeholder="TODO推荐内容" clearButton="always" cancelButton="always" @confirm="search" @cancel="cancel" />
	</view>
</template>
 ...
 <template>
 	<view class="container">
		...
		<view class="" style="display: flex;">
			<image src="../../static/image/search/question.png" style="width: 10%" mode="widthFix"></image>
			<text>有任何问题可以点击图片进行反馈</text>
		</view>
 	</view>
 </template>
 	...
 	export default {
 		data() {
 			return {
 				...
 				hotWorld: '华东师范大学', //	搜索热词，如果没有输入即回车，则搜索热词，但是不会加入搜索记录
 				focus: true, //	是否自动聚焦
